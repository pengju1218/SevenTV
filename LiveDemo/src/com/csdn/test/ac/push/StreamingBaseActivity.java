...
import com.csdn.test.view.gles.FBO;
import com.csdn.test.view.CameraPreviewFrameView;
import com.csdn.test.view.RotateLayout;
...
public class StreamingBaseActivity extends Activity implements
 ...
 //   private TextView mLogTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_t);
//
...
//        Log.i(TAG, "old onPreviewFrame cost :" + (System.currentTimeMillis() - start));
    ...
    public void onSurfaceChanged(int width, int height) {
        ...
        Log.i("aaweaweaw", "onSurfaceChanged width:" + width + ",height:" + height);
