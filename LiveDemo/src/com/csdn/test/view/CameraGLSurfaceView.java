...
public class CameraGLSurfaceView extends GLSurfaceView implements
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        CameraManger.getInstance().doOpenCamera(mSurface);
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        if(!CameraManger.getInstance().isPreviewing()){
            CameraManger.getInstance().doStartPreview(mSurface);
        }
    }
    ...
    public void onPause() {
        // TODO Auto-generated method stub
        super.onPause();
        CameraManger.getInstance().doStopCamera();
    }
